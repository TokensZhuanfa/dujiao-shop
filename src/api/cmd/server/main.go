...
import (
	...
	"github.com/TokensZhuanfa/dujiao-shop/internal/app"
	...
	"github.com/TokensZhuanfa/dujiao-shop/internal/version"
...
func printStartupBanner() {
	...
	fmt.Println(ansiBrightMag + "║                      🚀 dujiao-shop API 启动中                       ║" + ansiReset)
	fmt.Println(ansiBrightMag + "╚══════════════════════════════════════════════════════════════════════╝" + ansiReset)
	...
	fmt.Println(ansiCyan + "██████╔╝╚██████╔╝╚█████╔╝██║  ██║╚██████╔╝     ███████║██║  ██║╚██████╔╝██║     " + ansiReset)
	fmt.Println(ansiCyan + "╚═════╝  ╚═════╝  ╚════╝ ╚═╝  ╚═╝ ╚═════╝      ╚══════╝╚═╝  ╚═╝ ╚═════╝ ╚═╝     " + ansiReset)
	fmt.Println(ansiGreen + ansiBold + "Open Source" + ansiReset)
	fmt.Println(ansiBlue + "• Repo:    https://github.com/TokensZhuanfa/dujiao-shop" + ansiReset)
	fmt.Println(ansiBlue + "• Issues:  https://github.com/TokensZhuanfa/dujiao-shop/issues" + ansiReset)
	fmt.Println(ansiBlue + "• Release: https://github.com/TokensZhuanfa/dujiao-shop/releases" + ansiReset)
