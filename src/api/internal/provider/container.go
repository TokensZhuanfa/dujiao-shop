...
type Container struct {
	...
	CredentialFileService     *service.CredentialFileService
	...
	CodexAccountService       *service.CodexAccountService
...
func (c *Container) initRepositories() {
	...
	c.CodexAccountRepo = repository.NewCodexAccountRepository(db)
...
func (c *Container) initServices() {
	...
	c.CredentialFileService = service.NewCredentialFileService(c.Config)
	c.AffiliateService = service.NewAffiliateService(c.AffiliateRepo, c.UserRepo, c.OrderRepo, c.ProductRepo, c.SettingService)
	c.ProductService = service.NewProductService(c.ProductRepo, c.ProductSKURepo, c.CardSecretRepo, c.CardSecretBatchRepo, c.CategoryRepo, c.MemberLevelPriceRepo, c.CartRepo, c.ProductMappingRepo, c.OrderRepo, c.CodexAccountRepo, c.CredentialFileService)
	...
	c.OrderService = service.NewOrderService(service.OrderServiceOptions{
		...
		CodexAccountRepo:      c.CodexAccountRepo,
	...
	c.FulfillmentService = service.NewFulfillmentService(
		c.OrderRepo, c.FulfillmentRepo, c.CardSecretRepo, c.ProductRepo, c.CodexAccountRepo, c.QueueClient,
		c.SettingService, c.Config.Email,
		c.UserOAuthIdentityRepo,
	)
	c.CardSecretService = service.NewCardSecretService(c.CardSecretRepo, c.CardSecretBatchRepo, c.ProductRepo, c.ProductSKURepo, c.CredentialFileService)
	c.CodexAccountService = service.NewCodexAccountService(c.CodexAccountRepo, c.SettingService)
	c.CodexAccountService.StartAutoRefresh(context.Background())
